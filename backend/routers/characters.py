...
async def get_character(
    character_id: str = Path(..., description="Character ID, or archetype 'magician' / 'archer'")
):
    """Retrieves a character profile and loadout, seeding default archetype if not found."""
...
async def save_character(save_data: CharacterSaveRequest):
    """Persists character stats, coordinates, and 6-slot backpack / 3-slot paperdoll inventory."""
