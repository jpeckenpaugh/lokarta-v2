/**
 * AudioSystem: Procedural Web Audio API sound synthesizer for Lokarta.
 * 
 * Provides low-latency, zero-dependency 8-bit / 16-bit dungeon audio:
 * - Footsteps and movement
 * - Combat abilities (Wand Spark, Light Spell, Energy Beam, Bow Shot, Power Shot)
 * - Melee impacts and enemy attacks
 * - Monster damage and defeat dissolves
 * - Item pickup, stacking, drinking potions, equipment swapping
 * - Floor clearance, stairs warp, victory fanfare, defeat
 * - UI interaction clicks and mute/unmute toggle
 */
...
export class AudioSystem {
  ...
  /**
   * Initializes or unlocks the AudioContext on first user interaction.
   */
  public init(): void {
  ...
  public playFootstep(): void {
    ...
    // Subtle pitch fluctuation for organic footsteps
